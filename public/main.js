import { createLandingTitle, hideModelViewer, hideTypeIt, initTypeIt } from "./js/components/landing_title.js"
...
// 클릭 직후에 프로그레스바가 0%에서 100%로 가짜로 차오르는 함수
        ...
        for (let i=0; i<post.tags.length; i++) {
            ...
            switch (tag_type) {
                case 'Financial Engineering':
                    postTag.classList.add('financial_engineering');
                    break;
                case 'Math':
                    postTag.classList.add('math');
                    break;
                default:
